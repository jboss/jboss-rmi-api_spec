...
// Generated from input file src/main/resources/org/jboss/com/sun/corba/se/spi/logging/data/Util.mc on Wed Feb 02 17:13:22 PST 2011
...
public class UtilSystemException extends LogWrapperBase
{
    ...
    public BAD_OPERATION errorInMakeStubFromRepositoryId(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.FINE, "UTIL.errorInMakeStubFromRepositoryId", parameters, UtilSystemException.class, exc);
        }
    ...
    public BAD_OPERATION classCastExceptionInLoadStub(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.FINE, "UTIL.classCastExceptionInLoadStub", parameters, UtilSystemException.class, exc);
        }
    ...
    public INTERNAL badBeginUnmarshalCustomValue(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "UTIL.badBeginUnmarshalCustomValue", parameters, UtilSystemException.class, exc);
        }

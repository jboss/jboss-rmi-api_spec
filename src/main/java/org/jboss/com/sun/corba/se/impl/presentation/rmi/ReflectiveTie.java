...
public final class ReflectiveTie extends Servant implements Tie
{
            ...
            ResponseHandler reply)
    {
        ...
        {
            throw wrapper.invocationErrorInReflectiveTie(ex, javaMethod.getName(), javaMethod.getDeclaringClass()
                    .getName());
        }
        ...
        {
            // Unwrap the actual exception so that it can be wrapped by an UnknownException or thrown if it is a system
            // exception.

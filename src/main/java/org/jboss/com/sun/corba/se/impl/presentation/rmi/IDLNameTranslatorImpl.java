...
public class IDLNameTranslatorImpl implements IDLNameTranslator {
    ...
    private void buildNameTranslation()
    {
        ...
        //
        for(Iterator<IDLMethodInfo> outerIter=allMethodInfo.values().iterator();
            outerIter.hasNext();) {
            IDLMethodInfo outer = outerIter.next();
            for(Iterator<IDLMethodInfo> innerIter = allMethodInfo.values().iterator();
                innerIter.hasNext();) {
        ...
        for(Iterator<IDLMethodInfo> iter = allMethodInfo.values().iterator();
            iter.hasNext();) {
    ...
    public String toString() {
        ...
        contents.append("]\n");
        for(Iterator<Method> iter = methodToIDLNameMap_.keySet().iterator();
            iter.hasNext();) {

            ...
            org.omg.CORBA.portable.ValueOutputStream
{
    ...
    // REVISIT - These two constructors should be re-factored to better hide the fact that someone extending this class
    // 'can' construct a CDROutputStream that does not use pooled ByteBuffers. Right now, only EncapsOutputStream does
    // _not_ use pooled ByteBuffers, see EncapsOutputStream.

    // NOTE: When a stream is constructed for non-channel-backed sockets it notifies the constructor not to use pooled
    // (i.e, direct) ByteBuffers.
    ...
    // org.jboss.com.sun.corba.se.impl.encoding.MarshalOutputStream

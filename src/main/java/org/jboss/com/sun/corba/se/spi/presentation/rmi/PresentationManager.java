...
/**
 * Provides access to RMI-IIOP stubs and ties. Any style of stub and tie generation may be used. This includes compiler
 * generated stubs and runtime generated stubs as well as compiled and reflective ties. There is normally only one
 * instance of this interface per VM. The instance is obtained from the static method
 * org.jboss.com.sun.corba.se.spi.orb.ORB.getPresentationManager.
 * <p>
...
public interface PresentationManager
{
    ...
    {
        /**
         * Return the standard name of a stub (according to the RMI-IIOP specification and rmic). This is needed so that
         * the name of a stub is known for standalone clients of the app server.
         */
        String getStubName(String className);

        /**
         * Create a stub factory for stubs for the interface whose type is given by className. className may identify
         * either an IDL interface or an RMI-IIOP interface.
         * 
         * @param className
         ...
         *            The CodeBase to use for loading Stub classes, if necessary (may be null or unused).
         * @param expectedClass
         *            The expected stub type (may be null or unused).
         * @param classLoader
         *            The classLoader to use (may be null).
         */
        PresentationManager.StubFactory createStubFactory(String className, boolean isIDLStub, String remoteCodeBase,
        ...
        /**
         * Return whether or not this StubFactoryFactory creates StubFactory instances that create dynamic stubs and
         * ties. At the top level, true indicates that rmic -iiop is not needed for generating stubs or ties.
         */
    ...
    public interface ClassData
    {
        ...
        /**
         * Get the dictionary for this ClassData instance. This is used to hold class-specific information for a Class
         * in the class data. This avoids the need to create other caches for accessing the information.
         */
        Map<Object,Object> getDictionary();
    }

    /**
     * Get the ClassData for a particular class. This class may be an implementation class, in which case the
    ...
    /**
     * Given a particular method, return a DynamicMethodMarshaller for that method. This is used for dynamic stubs and
     * ties.
     */
    ...
    /**
     * Register the StubFactoryFactory. Note that a static StubFactoryFactory is always required for IDL. The dynamic
     * stubFactoryFactory is optional.
     */
     ...
     * PresentationManager as used in the app server. The class argument is ignored in the dynamic case, so this is
     * safe.
     */
    Tie getTie();

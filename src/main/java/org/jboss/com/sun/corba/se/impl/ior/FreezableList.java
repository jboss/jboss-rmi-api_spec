...
{
    private List<Object> delegate = null;
    ...
    public FreezableList(List<Object> delegate, boolean immutable)
    {
        this.delegate = delegate;
        this.immutable = immutable;
    }

    public FreezableList(List<Object> delegate)
    {
        this(delegate, false);
    }
    ...
    {
        List<Object> list = delegate.subList(fromIndex, toIndex);
        List<Object> result = new FreezableList(list, immutable);
        return result;
    }
}

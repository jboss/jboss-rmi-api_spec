...
/**
 * Describes CDRInputStream delegates and provides some implementation. Non-default constructors are avoided in the
...
abstract class CDRInputStreamBase extends java.io.InputStream
{
    ...
    public abstract java.io.Serializable read_value(Class<?> clz);

    public abstract java.io.Serializable read_value(org.omg.CORBA.portable.BoxedValueHelper factory);

    public abstract java.io.Serializable read_value(String rep_id);

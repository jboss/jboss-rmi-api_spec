...
class CodeSetCache
{
     ...
     */
    private ThreadLocal<Object> converterCaches = new ThreadLocal<Object>()
    {
        public Object initialValue()
        {
            return new Map[]{new WeakHashMap<Object, Object>(), new WeakHashMap<Object, Object>()};
        }
    };

    /**
     * Index in the thread local converterCaches array for the byte to char converter Map. A key is the Java name
     * corresponding to the desired code set.
     */
    private static final int BTC_CACHE_MAP = 0;

    /**
     * Index in the thread local converterCaches array for the char to byte converter Map. A key is the Java name
     * corresponding to the desired code set.
     */

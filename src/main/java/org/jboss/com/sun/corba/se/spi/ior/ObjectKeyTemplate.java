 ...
 * object reference. The template is shared between many object references.
 */
public interface ObjectKeyTemplate extends Writeable
{
    ...
    /**
     * Compute an adapter ID for this template than includes all of the template information. This value is cached to
     * avoid the expense of recomputing it.
     */

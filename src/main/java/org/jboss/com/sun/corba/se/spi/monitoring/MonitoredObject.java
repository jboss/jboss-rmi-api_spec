...
/**
 * <p>
 * Monitored Object provides an Hierarchichal view of the ORB Monitoring System. It can contain multiple children and a
 * single parent. Each Monitored Object may also contain Multiple Monitored Attributes.
 * </p>
 * 
...
public interface MonitoredObject
{
    ...
    /**
     * <p>
     * Gets the child MonitoredObject associated with this MonitoredObject instance using name as the key. The name
     * should be fully qualified name like orb.connectionmanager
     * </p>
     * <p>
     * 
    ...
    /**
     * <p>
     * There will be only one parent for an instance of MontoredObject, this call gets parent and returns null if the
     * Monitored Object is the root.
     * </p>
     * <p>
     * 
     ...
     * 
     * @param value
     *            is the MonitoredAttribute which will be set as one of the attribute of this MonitoredObject.
     *            </p>
     */
    ...
    /**
     * <p>
     * Gets all the Monitored Attributes for this Monitored Objects. It doesn't include the Child Monitored Object, that
     * needs to be traversed using getChild() or getChildren() call.
     * </p>
     * <p>
     * 
    ...
    /**
     * <p>
     * Clears the state of all the Monitored Attributes associated with the Monitored Object. It will also clear the
     * state on all it's child Monitored Object. The call to clearState will be initiated from

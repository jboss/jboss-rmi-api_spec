...
/**
 * Describes CDROutputStream delegates and provides some implementation. Non-default constructors are avoided in the
...
abstract class CDROutputStreamBase extends java.io.OutputStream
{
    ...
    // See EncapsOutputStream, the only one that uses the non-pooled ByteBuffers, for additional info.
    protected abstract void init(org.omg.CORBA.ORB orb, boolean littleEndian, BufferManagerWrite bufferManager,
    ...
    public abstract void write_longdouble(double value);

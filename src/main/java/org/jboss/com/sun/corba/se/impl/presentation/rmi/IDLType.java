...
public class IDLType
{
    ...
    {
        // Note that this should probably be makeConcatenatedName( '/', true ) for spec compliance, but rmic does it
        // this way, so we'll leave this.
        // The effect is that an overloaded method like void foo( bar.typedef.Baz ) will get an IDL name of
        // foo__bar_typedef_Baz instead of foo__bar__typedef_Baz (note the extra _ before typedef).
    ...
    public String getExceptionName()
    {
        ...
        // This means that the repository ID for foo.exception.SomeException is "IDL:foo/_exception/SomeEx:1.0" (note
        // the underscore in front of the exception module name).
    ...
    /**
     * True if this type doesn't have a containing module. This would be true of a java type defined in the default
     * package or a primitive.
     */

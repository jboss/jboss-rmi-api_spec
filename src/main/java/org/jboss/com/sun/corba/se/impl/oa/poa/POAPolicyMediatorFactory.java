...
{
    // create an appropriate policy mediator based on the policies. Note that the policies object has already been
    // validated before this call, so it can only contain valid combinations of POA policies.

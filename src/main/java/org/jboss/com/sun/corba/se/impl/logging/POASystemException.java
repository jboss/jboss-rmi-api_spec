...
// Generated from input file src/main/resources/org/jboss/com/sun/corba/se/spi/logging/data/POA.mc on Wed Feb 02 17:13:21 PST 2011
...
public class POASystemException extends LogWrapperBase
{
    ...
    public INTERNAL policyMediatorBadPolicyInFactory(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "POA.policyMediatorBadPolicyInFactory", parameters, POASystemException.class, exc);
        }
    ...
    public OBJ_ADAPTER poaServantActivatorLookupFailed(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "POA.poaServantActivatorLookupFailed", parameters, POASystemException.class, exc);
        }
    ...
    public OBJ_ADAPTER poaServantLocatorLookupFailed(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "POA.poaServantLocatorLookupFailed", parameters, POASystemException.class, exc);
        }
    ...
    public UNKNOWN unknownLocalinvocationError(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "POA.unknownLocalinvocationError", parameters, POASystemException.class, exc);
        }
    ...
    public OBJECT_NOT_EXIST adapterActivatorNonexistent(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "POA.adapterActivatorNonexistent", parameters, POASystemException.class, exc);
        }

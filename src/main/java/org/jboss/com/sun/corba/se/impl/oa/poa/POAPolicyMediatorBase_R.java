...
public abstract class POAPolicyMediatorBase_R extends POAPolicyMediatorBase
{
            ...
            ObjectAlreadyActive
    {
        ...
        // Note that this can't happen for system assigned IDs since the POA never hands out the same ID. However, we
        // make this redundant check here to share the code.
    ...
    protected void deactivateHelper(ActiveObjectMap.Key key, AOMEntry entry, Servant s) throws ObjectNotActive,
            WrongPolicy
    {
        // Default does nothing, but the USE_SERVANT_MANAGER case must handle etherealization

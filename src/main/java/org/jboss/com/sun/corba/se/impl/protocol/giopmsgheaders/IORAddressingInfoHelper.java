...
/**
 * org/jboss/com/sun/corba/se/impl/protocol/giopmsgheaders/IORAddressingInfoHelper.java Generated by the IDL-to-Java compiler
        ...
        if (__typeCode == null)
        {
            synchronized (org.omg.CORBA.TypeCode.class)
            {
                if (__typeCode == null)
                {
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(IORAddressingInfoHelper.id(),

...
{
    /*
     * This class must override add( int, Object ) and set( int, Object ) so that adding an IORTemplateList to an
     * IORTemplateList just results in a list of TaggedProfileTemplates.
     */

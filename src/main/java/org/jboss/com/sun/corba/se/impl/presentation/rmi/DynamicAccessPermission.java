...
/**
 * This class controls the use of dynamic proxies. A DynamicAccessPermission contains a name (also referred to as a
...
public final class DynamicAccessPermission extends BasicPermission
{
    ...
    private static final long serialVersionUID = -5483726771964012090L;
    ...
    /**
     * Creates a new DynamicAccessPermission object with the specified name. The name is the symbolic name of the
     * DynamicAccessPermission, and the actions String is currently unused and should be null.
     * 
     * @param name
     *            the name of the DynamicAccessPermission.
     * @param actions

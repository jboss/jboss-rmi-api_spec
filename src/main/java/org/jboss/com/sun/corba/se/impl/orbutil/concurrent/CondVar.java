...
public class CondVar
{
     ...
     *            is to supply an instance of <code>Mutex</code>, but, for example, a Semaphore initialized to 1 also
     ...
     *            used for <em>all</em> synchronization of the object using the CondVar. Generally, to prevent nested
     *            monitor lockouts, this object should not use any native Java synchronized blocks.
     **/

...
/**
 * Base template for creating TaggedProfiles. A TaggedProfile will often contain tagged components. A template that does
 * not contain components acts like an empty immutable list.
 * 
 * @author Ken Cavanaugh
 */
public interface TaggedProfileTemplate extends List<Object>, Identifiable, WriteContents, MakeImmutable
{
    /**
     ...
     */
    public Iterator<Object> iteratorById(int id);
    ...
    /**
     * Return true if temp is equivalent to this template. Equivalence means that in some sense an invocation on a
     * profile created by this template has the same results as an invocation on a profile created from temp.

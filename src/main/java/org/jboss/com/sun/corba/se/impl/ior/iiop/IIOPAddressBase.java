...
{
    // Ports are marshalled as shorts on the wire. The IDL type is unsigned short, which lacks a convenient
    // representation in Java in the 32768-65536 range. So, we treat ports as ints throught this code, except that
    // marshalling requires a scaling conversion. intToShort and shortToInt are provided for this purpose.

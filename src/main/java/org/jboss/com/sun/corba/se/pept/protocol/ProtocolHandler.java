...
/**
 * <code>ProtocolHandler</code> is used to determine the type of an incoming message.
 * 
 * @author Harold Carr
 */
public interface ProtocolHandler
{
     ...
     * {@link org.jboss.com.sun.corba.se.pept.protocol.ServerRequestDispatcher ServerRequestDispatcher} to handle the
     * request. On the client-side it may signal a waiting thread to handle a reply.
     * 
     * @return deprecated
     */

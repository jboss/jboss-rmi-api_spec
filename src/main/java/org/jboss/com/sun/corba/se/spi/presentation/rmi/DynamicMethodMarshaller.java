...
public interface DynamicMethodMarshaller
{
    ...
    /**
     * Copy the arguments as needed for this particular method. Can be optimized so that as little copying as possible
     * is performed.
     */
    ...
    /**
     * Write the repository ID of the exception and the value of the exception to the OutputStream. ex should be a
     * declared exception for this DynamicMethodMarshaller's method.
     */
    void writeException(OutputStream os, Exception ex);

    /**
     * Reads an exception ID and the corresponding exception from the input stream. This should be an exception declared
     * in this method.
     */

...
/**
 * <p>
 * <code>Connection</code> represents a <em>transport</em> in the PEPt architecture.
 * </p>
 * 
 * @author Harold Carr
 */
public interface Connection
{
     ...
     * {@link org.jboss.com.sun.corba.se.pept.transport.TransportManager TransportManager}
     * {@link org.jboss.com.sun.corba.se.pept.transport.Selector Selector} to handle read events.
     * 
    ...
    /**
     * Get the {@link org.jboss.com.sun.corba.se.pept.transport.Acceptor Acceptor} that created this <code>Connection</code>.
     * 
     * @return {@link org.jboss.com.sun.corba.se.pept.transport.Acceptor Acceptor}
     */
    public Acceptor getAcceptor();

    /**
     * Get the {@link org.jboss.com.sun.corba.se.pept.transport.ContactInfo ContactInfo} that created this <code>Connection</code>
     * .
     * 
     * @return {@link org.jboss.com.sun.corba.se.pept.transport.ContactInfo ContactInfo}
     */
    ...
    /**
     * Indicates whether a {@link org.jboss.com.sun.corba.se.pept.transport.ContactInfo ContactInfo} or a
     * {@link org.jboss.com.sun.corba.se.pept.transport.Acceptor Acceptor} created the <code>Connection</code>.
     * 
     * @return <code>true</code> if <code>Connection</code> an {@link org.jboss.com.sun.corba.se.pept.transport.Acceptor Acceptor}
     ...
     * calling thread must call {@link #writeUnlock} when it is done.
     */
    ...
    /*
     * Send the data encoded in {@link org.jboss.com.sun.corba.se.pept.encoding.OutputObject OutputObject} on the
    ...
    /**
     * Register an invocation's {@link org.jboss.com.sun.corba.se.pept.protocol.MessageMediator MessageMediator} with the
     * <code>Connection</code>.
     * 
    ...
    /**
     * Unregister an invocation's {@link org.jboss.com.sun.corba.se.pept.protocol.MessageMediator MessageMediator} with the
     * <code>Connection</code>.
     * 
     * @param messageMediator
     */

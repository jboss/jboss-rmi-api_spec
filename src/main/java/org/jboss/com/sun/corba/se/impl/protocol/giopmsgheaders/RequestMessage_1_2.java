...
public final class RequestMessage_1_2 extends Message_1_2 implements RequestMessage
{
    ...
    RequestMessage_1_2(ORB orb, int _request_id, byte _response_flags, byte[] _reserved, TargetAddress _target,
    ...
    {
        /*
         * case 1: LSBit[1] == 1 not a oneway call (DII flag INV_NO_RESPONSE is false) // Ox03 LSBit[0] must be 1. case
         * 2: LSBit[1] == 0 if (LSB[0] == 0) // Ox00 oneway call else if (LSB[0] == 1) // 0x01 oneway call; but server
         * may provide a location forward response or system exception response.
         */

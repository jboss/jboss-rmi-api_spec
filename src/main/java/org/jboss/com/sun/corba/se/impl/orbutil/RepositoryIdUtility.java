...
public interface RepositoryIdUtility
{
    ...
    // These are currently the same in both RepositoryId and RepositoryId_1_3, but provide the constants again here to
    // eliminate awkardness when using this interface.
    ...
    // Determine how many (if any) repository IDs follow the value tag.

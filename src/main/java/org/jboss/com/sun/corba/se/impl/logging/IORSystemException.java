...
// Generated from input file src/main/resources/org/jboss/com/sun/corba/se/spi/logging/data/IOR.mc on Wed Feb 02 17:13:17 PST 2011
...
public class IORSystemException extends LogWrapperBase
{
    ...
    public INTERNAL taggedProfileTemplateFactoryNotFound(CompletionStatus cs, Throwable t, Object arg0)
    {
        ...
        if (logger.isLoggable(Level.WARNING))
        {
            Object[] parameters = new Object[1];
            parameters[0] = arg0;
            doLog(Level.WARNING, "IOR.taggedProfileTemplateFactoryNotFound", parameters, IORSystemException.class, exc);
        }
    ...
    public BAD_OPERATION objectAdapterIdNotAvailable(CompletionStatus cs, Throwable t)
    {
        ...
        {
            Object[] parameters = null;
            doLog(Level.WARNING, "IOR.objectAdapterIdNotAvailable", parameters, IORSystemException.class, exc);
        }

...
public class ObjectReferenceFactoryImpl extends ObjectReferenceProducerBase
        implements
            ...
            StreamableValue
{
    private static final long serialVersionUID = -6209340217525197778L;
    ...
    /**
     * Read the data into a (presumably) empty ObjectReferenceFactoryImpl. This sets the orb to the ORB of the
     * InputStream.
     */

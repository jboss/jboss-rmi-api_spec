...
import org.jboss.com.sun.corba.se.spi.ior.WriteContents;
...
public class EncapsulationUtility
{
    ...
    /**
     * Read the count from is, then read count Identifiables from is using the factory. Add each constructed
     * Identifiable to container.
     */
    public static void readIdentifiableSequence(List<Object> container, IdentifiableFactoryFinder finder,
            InputStream istr)
    {
    ...
    public static void writeIdentifiableSequence(List<Object> container, OutputStream os)
    {
        ...
        Iterator<Object> iter = container.iterator();
        while (iter.hasNext())
        {

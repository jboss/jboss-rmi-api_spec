 ...
 *         </p>
 *         <p>
 *         This is used for getting the default factories for MonitoredObject, MonitoredAttributeInfo and
 *         MonitoringManager. We do not expect users to use the MonitoredAttributeInfo factory most of the time because
 *         the Info is automatically built by StringMonitoredAttributeBase and LongMonitoredAttributeBase.
 *         </p>
 */
public class MonitoringFactories
{
    ...
    /**
     * <p>
     * Gets the MonitoredAttributeInfoFactory. The user is not expected to use this Factory, since the
     * MonitoredAttributeInfo is internally created by StringMonitoredAttributeBase, LongMonitoredAttributeBase and
     * StatisticMonitoredAttribute. If User wants to create a MonitoredAttribute of some other special type like a
     * DoubleMonitoredAttribute, they can build a DoubleMonitoredAttributeBase like LongMonitoredAttributeBase and build
     * a MonitoredAttributeInfo required by MonitoredAttributeBase internally by using this Factory.
     * </p>
     * <p>
     * 
    ...
    /**
     * <p>
     * Gets the MonitoredManagerFactory. The user is not expected to use this Factory, since the ORB will be
     * automatically initialized with the MonitoringManager.
     * 
     * User can get hold of MonitoringManager associated with ORB by calling orb.getMonitoringManager( )
     * </p>
     * <p>
     * 

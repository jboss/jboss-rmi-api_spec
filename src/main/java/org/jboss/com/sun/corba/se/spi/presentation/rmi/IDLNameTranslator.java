...
public interface IDLNameTranslator
{
    ...
    /**
     * Get all methods for this remote interface. The methods are returned in a canonical order, that is, they are
     * always in the same order for a particular interface.
     */
    Method[] getMethods();

    /**
     * Get the method from this IDLNameTranslator's interfaces that corresponds to the mangled name idlName. Returns
     * null if there is no matching method.
     */

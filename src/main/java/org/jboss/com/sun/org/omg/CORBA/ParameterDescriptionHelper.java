...
/**
 * org/jboss/com/sun/org/omg/CORBA/ParameterDescriptionHelper.java Generated by the IDL-to-Java compiler (portable),
...
public final class ParameterDescriptionHelper
{
    ...
    public static org.jboss.com.sun.org.omg.CORBA.ParameterDescription extract(org.omg.CORBA.Any a)
    {
        ...
        if (__typeCode == null)
        {
            synchronized (org.omg.CORBA.TypeCode.class)
            {
                if (__typeCode == null)
                {
                    ...
                    _tcOf_members0 = org.jboss.com.sun.org.omg.CORBA.ParameterModeHelper.type();
                    _members0[3] = new org.omg.CORBA.StructMember("mode", _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
                            org.jboss.com.sun.org.omg.CORBA.ParameterDescriptionHelper.id(), "ParameterDescription",
                            _members0);
                    __active = false;
                }
            }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            org.jboss.com.sun.org.omg.CORBA.ParameterDescription value)
    {
        ostream.write_string(value.name);
        ostream.write_TypeCode(value.type);
        org.jboss.com.sun.org.omg.CORBA.IDLTypeHelper.write(ostream, value.type_def);
        org.jboss.com.sun.org.omg.CORBA.ParameterModeHelper.write(ostream, value.mode);
    }

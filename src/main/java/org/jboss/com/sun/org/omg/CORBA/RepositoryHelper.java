...
{
    private static String  _id = "IDL:org.jboss.com.sun.omg.org/CORBA/Repository:3.0";
        ...
        if (__typeCode == null)
            {
                ...
                __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.jboss.com.sun.org.omg.CORBA.RepositoryHelper.id (), "Repository", __typeCode);
            }
        return __typeCode;
    }

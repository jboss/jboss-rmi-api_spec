...
/**
 * org/jboss/com/sun/org/omg/CORBA/StructMemberSeqHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
    ...
    synchronized public static org.omg.CORBA.TypeCode type()
    {
        if (__typeCode == null)
        {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
                    org.jboss.com.sun.org.omg.CORBA.StructMemberSeqHelper.id(), "StructMemberSeq", __typeCode);
        }
        return __typeCode;
    }

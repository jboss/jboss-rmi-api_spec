...
public class PortableRemoteObject
{
    ...
    static
    {
        proDelegate = (javax.rmi.CORBA.PortableRemoteObjectDelegate) createDelegateIfSpecified(PortableRemoteObjectClassKey);
    }
     ...
     * making an explicit call. See the {@link javax.rmi.CORBA.Stub#connect} method for more information.
     * 
     * @param target
    ...
    {
        return AccessController.doPrivileged(new GetORBPropertiesFileAction());
    }
}
